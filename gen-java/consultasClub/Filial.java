...
public class Filial implements org.apache.thrift.TBase<Filial, Filial._Fields>, java.io.Serializable, Cloneable, Comparable<Filial> {
  ...
  static {
    ...
    tmpMap.put(_Fields.LOCALIDAD, new org.apache.thrift.meta_data.FieldMetaData("localidad", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.HORARIO_APERTURA, new org.apache.thrift.meta_data.FieldMetaData("horario_apertura", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.HORARIO_CIERRE, new org.apache.thrift.meta_data.FieldMetaData("horario_cierre", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.DIAMES_MANTENIMIENTO, new org.apache.thrift.meta_data.FieldMetaData("diames_mantenimiento", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (localidad == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'localidad' was not present! Struct: " + toString());
    }
    if (horario_apertura == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'horario_apertura' was not present! Struct: " + toString());
    }
    if (horario_cierre == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'horario_cierre' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'diames_mantenimiento' because it's a primitive and you chose the non-beans generator.
  ...
  private static class FilialStandardScheme extends org.apache.thrift.scheme.StandardScheme<Filial> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Filial struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetDiames_mantenimiento()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'diames_mantenimiento' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
